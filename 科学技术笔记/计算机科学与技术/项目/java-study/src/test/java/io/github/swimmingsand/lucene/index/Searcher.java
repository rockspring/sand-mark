...
public class Searcher {
    ...
    public static void search(String indexDir, String q) throws IOException,
        ...
        NumericRangeQuery numericRangeQuery = NumericRangeQuery.newIntRange("docLength", 100, 100, true, true);

        TermQuery query1 = new TermQuery(new Term("docLength", "100"));

        PhraseQuery phraseQuery = new PhraseQuery();
        phraseQuery.add(new Term("contents", "hello"));
        phraseQuery.add(new Term("contents", "world"));

        phraseQuery.setSlop(2);
        BytesRefBuilder bytesRefBuilder = new BytesRefBuilder();
        NumericUtils.intToPrefixCoded(100, 0, bytesRefBuilder);
