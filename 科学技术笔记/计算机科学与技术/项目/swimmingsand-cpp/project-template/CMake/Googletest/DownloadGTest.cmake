...
set(SAND_SAVE_CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS})
set(SAND_SAVE_CMAKE_RUNTIME_OUTPUT_DIRECTORY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY})
...
set(CMAKE_CXX_FLAGS ${SAND_SAVE_CMAKE_CXX_FLAGS})
set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${SAND_SAVE_CMAKE_RUNTIME_OUTPUT_DIRECTORY})
...
# targets.
add_subdirectory(${sand_gtest_src_dir} ${sand_gtest_build_dir} EXCLUDE_FROM_ALL)
